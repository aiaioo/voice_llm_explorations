...
class GeminiLiveAPI {
  ...
  sendInitialSetupMessages() {
    ...
    if (this.translationConfig) {
      generationConfig.translationConfig = this.translationConfig;
    } else {
    ...
    if (!this.translationConfig) {
      ...
      sessionSetupMessage.setup.systemInstruction = { parts: [{ text: this.systemInstructions }] };
      sessionSetupMessage.setup.tools = [{ functionDeclarations: tools }];
